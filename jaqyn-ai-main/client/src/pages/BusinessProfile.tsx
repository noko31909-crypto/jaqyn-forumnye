...
export default function BusinessProfile() {
  ...
  const businessQuery = trpc.business.list.useQuery(undefined, { enabled: !!user });
  const updateBusinessMutation = trpc.business.update.useMutation();

  useEffect(() => {
    if (!businessId && businessQuery.data && businessQuery.data.length > 0) {
      ...
      setFormData({
        ...
        peakHoursStart: business.peakHoursStart || "",
        peakHoursEnd: business.peakHoursEnd || "",
        quietHoursStart: business.quietHoursStart || "",
        quietHoursEnd: business.quietHoursEnd || "",
        targetROI: business.targetROI?.toString() || "",
      });
    }
