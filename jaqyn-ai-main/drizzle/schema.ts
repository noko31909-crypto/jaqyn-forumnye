...
export const businesses = mysqlTable("businesses", {
  ...
  category: varchar("category", { length: 100 }).notNull(), // Coffee Shop, Salon, Retail, etc.
  ...
  targetROI: decimal("targetROI", { precision: 5, scale: 2 }), // e.g., 3.5x
...
export const campaigns = mysqlTable("campaigns", {
  ...
  channels: varchar("channels", { length: 255 }), // comma-separated: SMS,Email,WhatsApp
